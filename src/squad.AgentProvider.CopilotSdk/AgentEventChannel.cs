...
/// </summary>
internal sealed class AgentEventChannel : IAsyncDisposable
{
    private const int myCapacity = 100;
    private static readonly TimeSpan myWriteTimeout = TimeSpan.FromSeconds(10);
    ...
    public AgentEventChannel(Action<Exception>? onOverload = null)
    {
        myOnOverload = onOverload;
        myChannel = Channel.CreateBounded<AgentEvent>(new BoundedChannelOptions(myCapacity)
        {
