...
/// separately from each plug-in. Carries the launch-owned <see cref="ILoggerFactory"/> so every hosting adapter can
/// build a typed logger for its <see cref="squad.Ui.Protocol.UiProtocolSession"/> without depending on a concrete
