...
### Slice 3 (done): Abort sequencing and terminal role failure
...
**Status: complete (d748d5b0e6).** `src/squad.Specs/Features/AbortSequencingAndTerminalRoleFailure.feature` covers
