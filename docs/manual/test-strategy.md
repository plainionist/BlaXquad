...
Tests focus on supported use cases rather than the internal structure of `Headquarters`, `SquadRuntime`, `SquadViewModel`, runtime
...
- `Headquarters`, `SquadRuntime`, or `SquadViewModel`;
